...
const Footer = () => {
  return (
    <footer className="px-6 md:px-16 lg:px-24 xl:px-32 pt-8 w-full text-gray-500 mt-20">
      ...
      <p className="pt-4 text-center text-xs md:text-sm pb-5 text-slate-500 dark:text-zinc-400">
        Copyright 2026 © <span className="font-semibold text-slate-900 dark:text-zinc-100">Quick AI</span>. All Rights Reserved.
      </p>
